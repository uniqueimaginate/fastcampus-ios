...
//  Weather
//
//  Created by Peter on 2022/02/14.
//
...
class ViewController: UIViewController {
    ...
    @IBAction func tabFetchWeatherButton(_ sender: Any) {
    ...
    func getCurrentWeather(cityName: String){
        guard let url = URL(string: "https://api.openweathermap.org/data/2.5/weather?q=\(cityName)&appid=0377ef849044ef3ede89efc121ba298e") else {
            return
        }
